...
class FSDPWebtextDataset(Dataset):
    def __init__(self, path, seq_len=512) -> None:
        super().__init__()
    ...
    def __getitem__(self, index):
        return {"source_ids": self.data[index],
            "source_mask": self.attention_mask[index], "target_ids": self.data[index]}