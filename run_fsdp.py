...
def fsdp_main(args):
    ...
    print("parameter_memory: %.4fG" % parameter_memory)
    print("peak_memory: %.4fG" % peak_memory)
    print("current_memory: %.4fG" % current_memory)
    print("grads_and_optimizer_states_memory: %.4fG" % grads_and_optimizer_states_memory)
    print("activation_memory: %.4fG" % activation_memory)
